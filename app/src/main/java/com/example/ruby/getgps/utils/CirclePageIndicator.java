...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        final int defaultPageColor = ContextCompat.getColor(context, R.color.default_circle_indicator_stroke_color);
        final int defaultFillColor = ContextCompat.getColor(context,R.color.colorPrimaryEv);
    ...
    private int measureLong(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (mViewPager == null)) {
            ...
            result = (int) (getPaddingLeft() + getPaddingRight()
                    + (count * 2 * mRadius) + (count - 1) * mRadius + 1 + mExtraSpacing);
